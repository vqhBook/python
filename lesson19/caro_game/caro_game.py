...
class Settings:
    def __init__(self):
        ...
        self.padx, self.pady = 5, 5 # pixel each margin 5, 5
        self.X_char, self.O_char = "X", "O"
        self.XO_font = ("Arial", self.cell_width - 6, "bold")
        ...
        self.about_icon = tk.PhotoImage(file="about_icon.png")
...
class CaroGame(tk.Tk):
    ...
    def _initialize(self):
        (toolbar_frame := ttk.Frame(self, relief="raised")).pack(ipady=2, fill="x")
        ...
        ttk.Button(toolbar_frame, image=self.sett.about_icon, command=self._on_about).pack(side="left", padx=10)
        ...
        (statusbar_frame := ttk.Frame(self, relief="raised")).pack(ipady=2, fill="x")
    ...
    def _on_about(self):
        messagebox.showinfo(title="About " + self.sett.title, message=self.sett.title + " Application",
